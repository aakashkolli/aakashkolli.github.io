const props = { viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 2, strokeLinecap: "round" as const, strokeLinejoin: "round" as const, className: "w-5 h-5" };
...
export const IconChevronDown = ({ className = "w-5 h-5" }) => (
  <svg {...props} strokeWidth={1.5} className={className}>
    <path d="M6 9l6 6 6-6" />
  </svg>
);
