...
export const CPPIcon = () => (
    <svg preserveAspectRatio="xMidYMid" viewBox="0 0 256 288" className="w-full h-full">
        <path
            fill="#649AD2"
